...
ans = 1.2599210498948732
values = []
error = []
print("Bisection method:\t\t", bisection_method(1, 2, function, 0, 2 ** -52, ans, values, error))
print("Newton method:\t\t\t", newton_method(1, function, der_function, 0, 2 ** -52, ans, values, error))
print("Secant method:\t\t\t", secant_method(1, 2, function, 0, 2 ** -52, ans, values, error))
